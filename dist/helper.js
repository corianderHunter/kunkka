...
var Gesture = /** @class */ (function () {
    function Gesture(_a) {
        var _b = _a.config, config = _b === void 0 ? {} : _b, _c = _a.onStart, onStart = _c === void 0 ? function () {
            return;
        } : _c, _d = _a.onMove, onMove = _d === void 0 ? function () {
            return;
        } : _d, _e = _a.onStop, onStop = _e === void 0 ? function () {
            return;
        } : _e, _f = _a.onSwiper, onSwiper = _f === void 0 ? function () {
            return;
        } : _f;
    ...
    Gesture.prototype.dispatchDirection = function (dx, dy, vx, vy) {
        if (!this.swiperDirections[0]) {
            ...
            else if (dx < 0 - this.swiperDistanceLimit &&
        ...
        if (!this.swiperDirections[1]) {
            ...
            else if (dy < 0 - this.swiperDistanceLimit &&
    ...
    Gesture.prototype.start = function (gestureState, evt) {
        ...
        var x0 = gestureState.x0, y0 = gestureState.y0, dx = gestureState.dx, dy = gestureState.dy, vx = gestureState.vx, vy = gestureState.vy;
    ...
    Gesture.prototype.stop = function (gestureState) {
        ...
        this.displacement = [dx, dy];
        this.dispatchDirection(dx, dy, vx, vy);
        var directions = this.swiperDirections.filter(function (v) { return v !== SwiperDirection.SLIENCE; });
...
var gestureHook = function (_a) {
    var config = _a.config, onStart = _a.onStart, onMove = _a.onMove, onStop = _a.onStop, onSwiper = _a.onSwiper;
    var gesture = useMemo(function () {
        return new Gesture({ config: config, onStart: onStart, onMove: onMove, onStop: onStop, onSwiper: onSwiper });
    }, [config, onStart, onMove, onStop, onSwiper]);
    var panReponder = useMemo(function () {
...
export var sideSwiperCreator = function (_a) {
    var size = _a.size, onSwiper = _a.onSwiper, _b = _a.config, config = _b === void 0 ? {} : _b, _c = _a.boundary, boundary = _c === void 0 ? defaultBoundary : _c;
    ...
    var sideSwiperReponder = PanResponder.create({
        ...
        onMoveShouldSetPanResponderCapture: function () { return false; },
        onPanResponderGrant: function (evt, gestureState) {
            gesture.start(gestureState, evt);
        },
        onPanResponderMove: function (evt, gestureState) {
